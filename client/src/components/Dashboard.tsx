    ...
    return (
        <div className="flex flex-col max-h-[100lvh] min-h-[100lvh] overflow-x-hidden overflow-y-auto">
            ...
            <div className="table-row-group flex-column h-full md:flex md:flex-row">
                ...
                <div
                    className="bg-gray-900 right-0 w-96 min-w-[24rem] max-w-[24rem] float-right overflow-y-hidden md:overflow-y-auto md:max-h-[calc(100svh-32px)]">
        ...
        <div className="flex flex-col max-h-[100lvh] min-h-[100lvh] overflow-x-hidden overflow-y-auto relative">
            ...
            <div className="absolute w-96 z-10 top-0 right-1 top-0">
                <div className="flex flex-col relative">
                    <ActionIcon className="relative left-80 mt-1 mb-2" color={'white'} onClick={() => {
                        setIsSearching(!isSearching)
                    }}>
                        {isSearching ? <IconX size={16}/> : <IconSearch size={16}/>}
                    </ActionIcon>
                    <div className="relative border-2 border-slate-50"
